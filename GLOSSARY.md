...
- **Ghost scan** — the transient wheel movement while `G` is held. It inspects prior user time, may cross many occurrences and reverse direction, and is never written as a path.
